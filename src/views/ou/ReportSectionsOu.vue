...
const sectionDefinitions = [
  ...
  { id: 'Раздел 3', title: 'Распределение обучающихся по направлениям дополнительных общеобразовательных программ, полу и формам обучения, человек', description: 'Структура контингента обучающихся по различным критериям' },
  { id: 'Раздел 4', title: 'Возрастной состав обучающихся, человек', description: 'Распределение обучающихся по возрастным группам' },
  { id: 'Раздел 5', title: 'Распределение численности обучающихся по источникам финансирования, человек', description: 'Финансирование образовательных программ' },
  ...
  { id: 'Раздел 7', title: 'Распределение работников по уровню образования и полу, человек', description: 'Характеристика кадрового состава организации' },
  { id: 'Раздел 8', title: 'Распределение работников по возрасту, человек', description: 'Возрастная структура персонала' },
  ...
  { id: 'Раздел 10', title: 'Сведения о помещениях', description: 'Детальная информация о помещениях организации' },
  { id: 'Раздел 11', title: 'Наличие и использование площадей, квадратный метр', description: 'Площади помещений и их использование' },
  { id: 'Раздел 12', title: 'Количество персональных компьютеров и информационного оборудования, штука', description: 'Техническое оснащение организации' },
  { id: 'Раздел 13', title: 'Информационная открытость организации', description: 'Наличие и использование информационных ресурсов' },
  { id: 'Раздел 14', title: 'Максимальная скорость доступа к сети Интернет', description: 'Технические характеристики интернет-соединения' },
  ...
  { id: 'Раздел 16', title: 'Расходы организации, тысяча рублей (с одним десятичным знаком)', description: 'Структура расходов по различным статьям' },
