...
const sectionNameMap: Record<string, string> = {
  ...
  'Раздел 4': 'Распределение численности обучающихся',
  'Раздел 5': 'Распределение работников по уровню образования',
  ...
  'Раздел 16': 'Финансирование программ',
  'Раздел 17': 'Безопасность и охрана',
  'Раздел 18': 'Затраты на цифровые технологии'
}
